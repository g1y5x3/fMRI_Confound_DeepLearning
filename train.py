...
def train(config, run=None):
  ...
  data_train = IXIDataset(data_dir="data/IXI_4x4x4", label_file="IXI_all_train.csv", bin_range=bin_range, transform=[CenterRandomShift(randshift=True), RandomMirror()])
  data_test  = IXIDataset(data_dir="data/IXI_4x4x4", label_file="IXI_all_test.csv",  bin_range=bin_range, transform=[CenterRandomShift(randshift=False)])
